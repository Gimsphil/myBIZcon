...
### 🎙️ Phase 3: Real-Time Audio Capture, Meeting Mode & Voice Pipeline [Completed]
*   **AudioRecorder (Multi-threaded)**: Real-time sound capture from PC Default Mic and WASAPI Loopback.
*   **Gemini Diarization**: Sends audio files to Gemini 1.5 Flash/Pro for native multimodal speaker separation (User, Speaker A, B), Korean translation, and summary extraction.
*   **Search-Assisted Web Copilot**: Auto-triggers web search lookups on meeting terms to populate a floating facts card.
